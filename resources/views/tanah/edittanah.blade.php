        ...
        <div class="content-viewport">
            <div class="row">
                ...
                <div class="col-lg-12 equel-grid">
                    ...
                    <div class="grid">
                        <p class="grid-header">Edit Data Tanah</p>
                        <div class="grid-body">
                            <div class="item-wrapper">
                                <form method="post" action="{{ route('tanah.update', $tanah->id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="number"
                                                ...
                                                value="{{ old('inp_harga') ?? $tanah->price }}">
                                            @error('inp_harga')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                value="{{ old('inp_lokasi') ?? $tanah->location }}">
                                            @error('inp_lokasi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="date"
                                                ...
                                                value="{{ old('inp_tglpeminjaman') ?? $tanah->loan_date?->format('Y-m-d') }}">

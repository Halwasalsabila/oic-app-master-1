        ...
        <div class="content-viewport">
            <div class="row">
                ...
                <div class="col-lg-12 equel-grid">
                    <div class="grid">
                        <p class="grid-header">Tambah Data Office</p>
                        <div class="grid-body">
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <textarea style="resize: auto" rows="5" class="form-control @error('inp_deskripsi') is-invalid @enderror"
                                                ...
                                                placeholder="Tambahkan deskripsi jika diperlukan&#10;Jika adan mengisi inputan tanggal peminjaman, berikan informasi tentang peminjamn dengan format <Peminjam : nama_peminjam> contoh : 'Peminjam : Budi'">{{ old('inp_deskripsi') }}</textarea>
                                            @error('inp_deskripsi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

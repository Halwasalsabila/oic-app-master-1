        ...
        <div class="content-viewport">
            <div class="row">
                ...
                <div class="col-lg-12 equel-grid">
                    <div class="grid">
                        <p class="grid-header">Edit Data Inv Card</p>
                        <div class="grid-body">
                            <div class="item-wrapper">
                                <form method="post" action="{{ route('invcard.update', $invcard->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row showcase_row_area">
                                        <div class="col-md-2 showcase_text_area">
                                            <label for="inp_name">Nama Inv Card *</label>
                                        </div>
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                class="form-control  @error('inp_name') is-invalid @enderror" id="inp_name"
                                                name="inp_name" placeholder="Masukan nama invcard"
                                                value="{{ old('inp_name') ?? $invcard->name }}">
                                            @error('inp_name')
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                value="{{ old('inp_inv_card') ?? $invcard->inventory_card }}">
                                            @error('inp_inv_card')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <select class="custom-select @error('inp_project') is-invalid @enderror"
                                                ...
                                                @foreach ($projects as $project)
                                                    <option value="{{ $project->id }}" @selected(old('inp_project') == $project->id or $invcard->project == $project->id)>
                                                        {{ $project->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="date"
                                                ...
                                                value="{{ old('inp_tglpembelian') ?? $invcard->buy_date?->format('Y-m-d') }}">
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="number"
                                                ...
                                                value="{{ old('inp_harga') ?? $invcard->price }}">
                                            @error('inp_harga')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                min="0" value="{{ old('inp_residu') ?? $invcard->residu_value }}">
                                            @error('inp_residu')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                value="{{ old('inp_penyusutan') ?? $invcard->depreciation_value }}">
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                value="{{ old('inp_lokasi') ?? $invcard->location }}">
                                            @error('inp_lokasi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="text"
                                                ...
                                                placeholder="Masukan data pemakai invcard"
                                                value="{{ old('inp_pemakai') ?? $invcard->user }}">
                                            @error('inp_pemakai')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <select class="custom-select @error('inp_kondisi') is-invalid @enderror"
                                                ...
                                                <option value="Baik" @selected(old('inp_kondisi') ?? $invcard->condition == 'Baik')>Baik</option>
                                                <option value="Rusak" @selected(old('inp_kondisi') ?? $invcard->condition == 'Rusak')>Rusak</option>
                                                <option value="Dijual" @selected(old('inp_kondisi') ?? $invcard->condition == 'Dijual')>Dijual</option>
                                                <option value="Hilang" @selected(old('inp_kondisi') ?? $invcard->condition == 'Hilang')>Hilang</option>
                                            </select>
                                            @error('inp_kondisi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <input type="date"
                                                ...
                                                value="{{ old('inp_tglpeminjaman') ?? $invcard->loan_date?->format('Y-m-d') }}">
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <div class="col-md-8 showcase_content_area">
                                            <textarea style="resize: auto" rows="5" class="form-control @error('inp_deskripsi') is-invalid @enderror"
                                                ...
                                                placeholder="Tambahkan deskripsi jika diperlukan&#10;Jika adan mengisi inputan tanggal peminjaman, berikan informasi tentang peminjamn dengan format <Peminjam : nama_peminjam> contoh : 'Peminjam : Budi'">{{ old('inp_deskrips') ?? $invcard->description }}</textarea>
                                            @error('inp_deskripsi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
